...
func (h *Handler) Kindy(w http.ResponseWriter, r *http.Request) {
	...
	//	Hello world, I'm read from a file!<br>
	//	Actually, that's a joke.. <strong>I'm really just a hardcoded string</strong>
	//
	//	<p>But I do have HTML!</p>
	//`)
